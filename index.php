  ...
  <body>
  		...
  		<div class="row">
  			<div class="col-md-4 col-6 mx-auto">
  						...
  						<div class="card-body">
  						 <form method="POST" id="add_parlour" action="">
  							  <div class="mb-1">
              					...
              					<select class="form-control form-control-sm" name="parlour_name" id="parlour_name">
                   ...
                   <div class="mb-1">
                    ...
                    <input type="text" class="form-control form-control-sm" name="net_sales" id="net_sales" oninput="add_number()">
                  </div>
                   <div class="mb-1">
                    <label for="" class="form-label">Vat</label>
                    <input type="text" class="form-control form-control-sm" name="vat" id="vat" oninput="add_number()">
                  </div>
                   <div class="mb-1">
                    <label for="" class="form-label">Gross Sales</label>
                    <input type="text" class="form-control form-control-sm" name="gross_sales" id="gross_sales">
                  </div>
                   <div class="mb-1">
    ...
    <script type="text/javascript">
      ...
      function add_number() {
         ...
         document.getElementById("gross_sales").value = result;
      }
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Parlour</h5>
        ...
        <div class="modal-body">
          ...
          <div class="mb-1">
           ...
           <div class="mb-1">
            ...
            <div class="mb-1">
              <label for="" class="form-label">Gross Sales</label>
               <input type="text" class="form-control form-control-sm" name="edit_gross_sales" id="edit_gross_sales">
             </div>
              <div class="mb-1">
                <label for="" class="form-label">Received Date</label>
 ...
 <script type="text/javascript">
      ...
      function add_number_2() {
         ...
         if (isNaN(second_number)) second_number = 0;
         var result = first_number + second_number;
         document.getElementById("edit_gross_sales").value = result;
      }
